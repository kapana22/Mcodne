'use client'
// /experts/[slug] — „მსგავსი ექსპერტები“ at the foot of the profile.
  ...
  return (
    <section className="mt-14 lg:mt-16 pt-10 border-t border-ink-100">
      <div className="flex items-baseline justify-between gap-4 flex-wrap mb-6">
        ...
        <Link href={`/experts${categorySlug ? `?category=${categorySlug}` : ''}`} className="text-meta text-ink-600 hover:text-ink-900 font-display font-semibold inline-flex items-center gap-1 transition-colors duration-fast">
