'use client'
// /experts/[slug] — the reviews block (list, one article, relative dates).
...
type ReviewItem = {
  ...
  // /api/experts/[slug] alongside its timestamp.
    ...
    <article className="py-6 first:pt-0 last:pb-0">
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="font-display text-body font-bold text-ink-900 leading-tight truncate">{anon ? 'ანონიმური კლიენტი' : r.student?.fullName ?? 'ანონიმური კლიენტი'}</div>
  ...
  return (
    <section id="reviews" className="mt-14 lg:mt-16 pt-10 border-t border-ink-100 scroll-mt-24">
      ...
      <h2 className="font-display text-h2 lg:text-h1 font-bold tracking-[-0.022em] text-ink-900 leading-tight">
        {total > 0 ? 'რას ამბობენ კლიენტები' : 'ჯერ არ არის შეფასება'}
      </h2>
