'use client'
// /experts — the row→card data layer: the API payload shape and every
...
export type Tutor = {
  slug?: string | null
  id: string
  /** ⚠️ THE PERSON, NOT THE PROFILE (2026-08-19). The merged catalogue is keyed
   *  on the USER (lib/catalogItems → personKeyOfConsult): a TutorProfile and a
   *  ServiceProfile for one human share nothing else, and without this the day
   *  somebody turns on their second capability they would appear twice. */
  userId?: string | null
  name: string
  photo: number
...
// The FIRST-PAINT list is now seeded by the server (app/experts/page.tsx calls
