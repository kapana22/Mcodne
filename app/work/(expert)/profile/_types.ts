...
// ⚠️ THE CONSULTATION SHAPES LEFT WITH THEIR TAB (2026-08-19). `ConsultTier`,
// `Consultation`, `ConsForm` and `ConsEdit` are declared in
// app/work/services/_consultations.tsx now — the only file that reads them —
// and `PendingDelete` lost its `cons` member for the same reason: nothing on
// this page deletes a service any more.
