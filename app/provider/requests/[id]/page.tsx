...
export default async function Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      <div className="mb-5">
        <Btn href="/provider/requests" variant="ghost" size="sm" iconLeft={<span aria-hidden>←</span>}>
          ყველა მოთხოვნა
        </Btn>
      </div>
      ...
      <div className="mt-6 max-w-[720px] flex flex-col gap-6">
        ...
        {outcome === 'WON' ? (
          <Card className="border-brand-300">
            ...
            <div className="mt-4">
              <Btn href="/provider/offers" size="sm">კონტაქტი და მიმოწერა</Btn>
            </div>
          </Card>
        ) : outcome === 'LOST' ? (
          <Card>
            ...
            <div className="mt-4">
              <Btn href="/provider/requests" variant="secondary" size="sm">ყველა მოთხოვნა</Btn>
            </div>
          </Card>
        ) : outcome === 'SETTLED' ? (
          ...
          <Card>
            ...
            <div className="mt-4">
              <Btn href="/provider/offers" variant="secondary" size="sm">ჩემი შეთავაზებები</Btn>
            </div>
          </Card>
        ) : p ? (
          <OfferForm
