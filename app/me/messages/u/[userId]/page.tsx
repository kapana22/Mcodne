...
export default function StudentPairThreadPage() {
  ...
  if (denied) {
    return (
      <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
        ...
        <div className="mt-4"><Btn variant="secondary" size="sm" href="/me/messages">სიაში დაბრუნება</Btn></div>
      </div>
    )
  }
  ...
  return (
    <BookingChat
      ...
      variant="fill"
      autoFocus
      header={(_booking, pair) => <ThreadHeader booking={null} counterparty={pair?.otherUser} backHref="/me/messages" alwaysBack showBookCta />}
      emptyState={{
