...
const SECTIONS = [
  ...
  },
  {
    ...
    title: '3. მომსახურება',
    body: [
      'პლატფორმა უზრუნველყოფს ტექნიკურ ინფრასტრუქტურას — პროფილს, მიმოწერას, შეფასებას. კონსულტაციის კონკრეტული შინაარსი, ხარისხი და შედეგი ექსპერტის პასუხისმგებლობაა.',
