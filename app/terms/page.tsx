...
const SECTIONS = [
  {
    ...
    body: [
      'მცოდნე (შემდგომ — „პლატფორმა“) არის ონლაინ პლატფორმა, რომელიც აკავშირებს მომხმარებლებს ექსპერტებთან. პლატფორმაზე რეგისტრაციით ან მისი გამოყენებით შენ თანხმდები წინამდებარე პირობებზე.',
  ...
  },
  {
    ...
    title: '3. მომსახურება',
    body: [
      'პლატფორმა უზრუნველყოფს ტექნიკურ ინფრასტრუქტურას — პროფილს, მიმოწერას, შეფასებას. სერვისის კონკრეტული შინაარსი, ხარისხი და შედეგი ექსპერტის პასუხისმგებლობაა.',
      'ექსპერტთა ცოდნა და გამოცდილება მოწმდება, თუმცა პლატფორმა არ იძლევა გარანტიას კონკრეტული შედეგის მიღწევის შესახებ. სერვისი არ ცვლის იურიდიულ, სამედიცინო ან ფინანსურ პროფესიულ დახმარებას სპეციფიკურ საკითხებში.',
    ],
  },
  {
    id: 'payments',
    ...
    body: [
      ...
      'ონლაინ გადახდები პლატფორმაზე ჯერ არ არის ამოქმედებული — ამჟამად მოთხოვნის დატოვება და შეთავაზების მიღება უფასოა. ონლაინ გადახდების ამოქმედების შემდეგ გადახდა განხორციელდება წინასწარ, შეთავაზებაზე დათანხმებისას: თანხა დაცულ ანგარიშზე შეინახება და ექსპერტს გადაერიცხება მხოლოდ სამუშაოს წარმატებით დასრულების შემდეგ.',
      ...
      PAYMENTS_LIVE
        ? `ფასიანი სამუშაოებიდან პლატფორმა იტოვებს კომისიას — ${COMMISSION_PCT}%-ს ექსპერტის შემოსავლიდან. ეს კომისია მოიცავს ტექნიკურ ინფრასტრუქტურას, გადახდის დამუშავებას და მხარდაჭერას.`
        : `ონლაინ გადახდების ამოქმედების შემდეგ ფასიანი სამუშაოებიდან პლატფორმა დაიტოვებს კომისიას — ${COMMISSION_PCT}%-ს ექსპერტის შემოსავლიდან. ეს კომისია მოიცავს ტექნიკურ ინფრასტრუქტურას, გადახდის დამუშავებას და მხარდაჭერას. სანამ ონლაინ გადახდები არ ამოქმედდება, მოთხოვნა უფასოა.`,
    ],
  },
  {
    id: 'cancellation',
    ...
    body: [
      // ⚠️ THE WINDOW WAS COUNTED BACK FROM A SESSION'S START AND NOTHING HAS
      // A START TIME ANY MORE (2026-08-26). It read
      // „სესიის დაწყებამდე ${CANCEL_CUTOFF_HOURS} საათით ადრე…" — a refund rule
      // for a booking the product stopped making on 2026-08-24. Terms that
      // describe a mechanic the site does not have are worse than terse ones:
      // they are what somebody quotes back in a dispute.
      'სანამ შეთავაზებას დაეთანხმები, მოთხოვნის დახურვა ნებისმიერ დროს შეგიძლია და არაფერს იხდი. დათანხმების შემდეგ გაუქმებას ექსპერტთან ათანხმებ.',
      'თუ ექსპერტმა სამუშაო არ შეასრულა, გადახდილი თანხა (ონლაინ გადახდების ამოქმედების შემდეგ) სრულად დაბრუნდება იმავე გადახდის მეთოდზე.',
    ],
  },
  {
    id: 'conduct',
    ...
    body: [
      ...
      `პლატფორმაზე იკრძალება: შეურაცხყოფა, დისკრიმინაცია, სპამი, ცრუ ინფორმაცია, უკანონო სერვისი, ინტელექტუალური საკუთრების დარღვევა, პლატფორმის მიღმა გარიგების ან ანგარიშსწორების მცდელობა პლატფორმის საკომისიოს გვერდის ავლის მიზნით${PAYMENTS_LIVE ? '' : ' — მათ შორის მას შემდეგ, რაც ონლაინ გადახდები ამოქმედდება'}.`,
