...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      'გადახდა ხორციელდება წინასწარ, სესიის დაჯავშნისას. თანხა ინახება უსაფრთხო escrow ანგარიშზე (TBC / BOG) და გადაერიცხება ექსპერტს მხოლოდ სესიის წარმატებით დასრულების შემდეგ.',
      'პლატფორმა იტოვებს კომისიას — 15%-ს ექსპერტის შემოსავლიდან. ეს კომისია მოიცავს ტექნიკურ ინფრასტრუქტურას, გადახდის დამუშავებას და მხარდაჭერას.',
    ],
  },
  {
    id: 'cancellation',
    ...
    body: [
      'სესიის დაწყებამდე 12 საათით ადრე შესაძლებელია უფასო გაუქმება სრული დაბრუნებით. 12 საათზე ნაკლებ დროში გაუქმებისას თანხა არ ბრუნდება, გარდა დასაბუთებული გამონაკლისებისა.',
      'თუ ექსპერტმა გააუქმა სესია ან არ გამოცხადდა, თანხა ავტომატურად ბრუნდება 3 სამუშაო დღეში იმავე გადახდის მეთოდზე.',
    ],
  },
  {
    id: 'conduct',
