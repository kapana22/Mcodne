...
export function ProfileSection({ me, fullName, setFullName, phone, setPhone, bio, setBio, avatarUrl, savingProfile, profileMsg, fileInput, uploading, saveProfile, pickAvatar, uploadAvatar, removeAvatar }: Props) {
  return (
