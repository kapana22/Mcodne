  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'დიახ — სესიის დაწყებამდე 12 საათით ადრე შესაძლებელია უფასო გაუქმება ან გადატანა. 12 საათზე ნაკლებ დროში გაუქმებისას თანხა არ ბრუნდება, გარდა დასაბუთებული გამონაკლისებისა.',
      },
      {
        q: 'რა მოხდება, თუ ექსპერტი არ გამოცხადდა?',
        a: 'თანხა ავტომატურად ბრუნდება 3 სამუშაო დღეში იმავე გადახდის მეთოდზე. ასეთი შემთხვევა გავლენას ახდენს ექსპერტის რეიტინგზე.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: 'თანხა ინახება escrow ანგარიშზე TBC/BOG-თან და ექსპერტს გადაერიცხება მხოლოდ სესიის წარმატებით დასრულების შემდეგ. ბარათის დეტალები არ ინახება ჩვენთან.',
      },
      {
        q: 'რომელი გადახდის მეთოდები მიიღება?',
        a: 'Visa, Mastercard, TBC Pay, BOG Pay და Apple Pay. საერთაშორისო კარტებისთვისაც მუშაობს.',
      },
      {
        q: 'შემიძლია მივიღო ინვოისი?',
        a: 'დიახ — ყოველი გადახდის შემდეგ ავტომატურად იგზავნება ინვოისი ელფოსტაზე. კომპანიის ინვოისისთვის შეიყვანე რეკვიზიტები „პარამეტრები → ბილინგში".',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'პლატფორმა იტოვებს 15% ექსპერტის შემოსავლიდან. ეს მოიცავს ტექნიკურ ინფრასტრუქტურას, გადახდის დამუშავებას, მხარდაჭერას და მარკეტინგს.',
      },
      {
        q: 'როდის მივიღებ თანხას?',
        a: 'თანხა გადმოირიცხება შენს ბანკის ანგარიშზე ყოველ ხუთშაბათს — წინა კვირის სესიების ჯამური თანხა. პირველი გადმორიცხვა შესრულდება 2 კვირაში.',
      },
    ],
  },
  {
...
const CHANNELS: Channel[] = [
  { icon: <Icon.chat className="w-6 h-6" />, t: 'სწრაფი ჩატი', d: 'საშუალო — 4 წუთი პასუხი', hours: 'სამშ-პარ. 09:00 — 19:00', cta: 'ჩატის გახსნა', href: 'mailto:hi@mcodne.ge', primary: true },
  { icon: <Icon.mail className="w-6 h-6" />, t: 'ელფოსტა', d: 'hi@mcodne.ge', hours: 'საშუალო — 4 სთ', cta: 'წერილის გაგზავნა', href: 'mailto:hi@mcodne.ge' },
  { icon: <Icon.phone className="w-6 h-6" />, t: 'სატელეფონო', d: '+995 32 222 22 22', hours: 'სამშ-პარ. 10:00 — 18:00', cta: 'დაგვირეკეთ', href: 'tel:+995322222222' },
]
