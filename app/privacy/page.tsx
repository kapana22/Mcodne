...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      `თუ ანგარიშს დასრულებული ჯავშნები ან მიმოწერა აქვს, ავტომატური წაშლა ჩერდება — ეს ჩანაწერები რჩება, სანამ მხარდაჭერა მათ ხელით არ დაამუშავებს (${PRIVACY_EMAIL}).`,
