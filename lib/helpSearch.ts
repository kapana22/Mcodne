...
export const TOPIC_KEYWORDS: Record<string, string[]> = {
  ...
  'how-to-book': ['დაჯავშნა', 'ჯავშანი', 'დავჯავშნო', 'ჩაწერა', 'ჩავიწერო', 'დანიშვნა', 'დავნიშნო',
    ...
    // ⚠️ THE BOOKING WORDS ABOVE STAY ON PURPOSE — a person still types
    // „როგორ დავჯავშნო", and a synonym list exists to meet the words people
    // use, not the words we use (the same reason lib/categorySeo keeps
    // „კონსულტაცია"). These are what the product calls it since 2026-08-24.
    'მოთხოვნა', 'მოთხოვნის დატოვება', 'როგორ დავტოვო მოთხოვნა', 'შეთავაზება',
    'შეთავაზებები', 'როგორ მივიღებ შეთავაზებას', 'რამდენი შეთავაზება'],
...
const SMALL_TALK: { match: string[]; reply: string }[] = [
  {
    ...
    reply: 'გამარჯობა! დაწერე კითხვა — ფასზე, მოთხოვნაზე, გაუქმებაზე ან ექსპერტად გახდომაზე.',
  },
  {
  ...
  },
  {
    ...
    reply: 'ვპასუხობ კითხვებს ფასზე, მოთხოვნაზე, შეთავაზებაზე, გაუქმებაზე, გადახდაზე და ექსპერტად გახდომაზე. დაწერე შენი კითხვა.',
  },
]
