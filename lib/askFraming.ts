...
const CATEGORIES: CatDef[] = [
  {
    ...
    intro: 'ეს კითხვა ბიზნესის სფეროშია. ქვემოთ ის ექსპერტები არიან, ვისაც სწორედ ამ ტიპის საკითხზე მიგიწევს — სტრატეგია, ზრდა, fundraising, ოპერაციები.',
    prepare: [
...
const GENERIC: Framing = {
  ...
  intro: 'აი ის შემოწმებული ექსპერტები, რომლებიც შენს კითხვას ყველაზე ახლოს არიან. აირჩიე და დაჯავშნე ვიდეო-სესია.',
  prepare: [
