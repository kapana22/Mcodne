...
export function WorkspaceShell({
  ...
  /** The same measure as a percentage — the bar above that line. Server-passed
   *  so the block is in the FIRST paint; it used to wait on the badge poll. */
  ...
  return (
    <div className="min-h-screen bg-ink-75 lg:flex lg:items-start">
      <WorkspaceSidebar badges={badges} groups={groups} unearnedTetri={unearnedTetri} grantPercent={grantPercent} />
